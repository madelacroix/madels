            ...
            <div className="lm:pt-[25vh] pt-[18vh] sm:pb-[10vh] px-[5vw] text-off-white xs:space-y-16 space-y-10">
                <div className="bg-vinorepo bg-cover bg-center project-div">
                    ...
                    <div className="project-div-p">
                        ...
                        <p>
                            Natoque orci lorem sit venenatis adipiscing. Orci purus dui ultrices nisi tincidunt. In sed vitae ut purus sit. Vestibulum velit dignissim hendrerit commodo ornare pharetra sit risus feugiat. Quis malesuada sem nunc dolor.
                        </p>
                    </div>
                </div>
