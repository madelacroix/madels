...
function Intro() {
    return (
        <div className="xs:h-screen h-[70vh]">
            <div className="flex justify-center">
                <div className="absolute xs:p-[5rem] xxs:p-[1rem] p-[0.5rem]">
                    ...
                    <div className="text-center py-[3vh] bg-almost-black rounded-b-xl -mt-[0.5vh]">
                        ...
                        <button className="bg-off-white font-rasfire py-[1vh] sm:px-[3vw] xs:px-[5vw] xxs:px-[8vw] px-[15vw] uppercase xxs:mt-[2vh] mt-[1vh] rounded-3xl sm:text-[1.8vh] text-[1.5vh] tracking-[1px]">
                            <h2>About Me</h2>
                        </button>
                    </div>
                </div>
            ...
            <div className="flex justify-center">
                <div className="absolute font-rasfire md:-mt-[14vh] md:ml-[5vw] sm:mt-[40vh] xs:mt-[35vh] mt-[25vh] md:-space-y-20 sm:-space-y-16 xxs:-space-y-12 -space-y-5">
                    <h1 className="md:text-[12vh] sm:text-[8vh] xxs:text-[5vh] text-[3vh] text-off-white uppercase md:ml-[8vw] opacity-70">Hi, my name is</h1>
